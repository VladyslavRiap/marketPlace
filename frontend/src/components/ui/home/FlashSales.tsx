...
const FlashSales: React.FC<FlashSalesProps> = ({ discountedProducts }) => {
  ...
  return (
    <div className="lg:py-40 py-4 lg:px-0 px-4 bg-gray-50 relative">
      <div className="mx-auto">
        ...
        <div className="flex flex-row justify-center pt-4">
          <Link href="/products?discounted=true" passHref>
